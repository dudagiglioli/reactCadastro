...
export default function Lista() {
  ...
  //exportando o flat list

  const route = useRoute();
  console.log("aaa");

  DATA.push({
    // recebendo parametros do cadastro
